...
class GradCAM:
    ...
    def __init__(self, model, device, dict_hyperparam=None):
        ...
        Args:
            ...
            dict_hyperparam (dict): Dictionary of hyperparameters for GradCAM. Defaults to None.
        """
    ...
    def compute_and_plot_explanation(self, image, **kwargs):
        ...
        grayscale_cam = self.explainer(input_tensor=img_tensor)[-1, :]
