...
class CLIPLaBosample:
    """Class to perform sample-based explanations using CLIPLaBo model.

    Attributes:
        model (torch.nn.Module): CLIPLaBo model for image captioning and concept disambiguation.
    """

    def __init__(self, model):
        """Initialize the CLIP_QDA_sample_ class.
    ...
    def compute_and_plot_explanation(self, image, **kwargs):
        ...
        with torch.no_grad():
            ...
            activations = self.model.plot_labo_explanation(
                scores,
                top_concepts=5,
